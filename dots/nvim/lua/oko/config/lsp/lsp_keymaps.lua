...
function M.get()
  ...
  M._keys = {
    ...
    { "<leader>cc", "<cmd>Neoconf global<CR>",                           desc = "Neoconf Global",        mode = { "n", "v" } },
    { "<leader>cr", vim.lsp.buf.rename,                                  desc = "Rename",                has = "rename" },
    { "<leader>ca", vim.lsp.buf.code_action,                             desc = "Code Action",           mode = { "n", "v" },     has = "codeAction" },
    { "<leader>cd", "<cmd>LspLineDiagnostics<CR>",                       desc = "Diagnostics: Line",     mode = { "n", "v" },     has = "codeAction" },
    -- { "<leader>ca", "<cmd>ActionsPreviewCodeAction<CR>", desc = "Code Action",           mode = { "n", "v" },     has = "codeAction" },
